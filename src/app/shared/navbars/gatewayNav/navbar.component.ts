...
import { GatewayNavbarservice } from './navbar.service';
import { Router } from '@angular/router';
import { ParseId, ParseOwner } from '../../../utilities/IdParser';

@Component({
  selector: 'app-gateway-navbar',
  templateUrl: './navbar.component.html',
  styleUrls: ['./navbar.component.scss'],
})
export class GatewayNavbarComponent implements OnInit {
  ...
  constructor(
    ...
    public _navbarService: GatewayNavbarservice,
